...
// Number of utf8 codepoints in the utf8 substring str,
// excluding the null terminating byte.
utf8_nonnull utf8_pure utf8_weak size_t utf8substrlen(const void *str, const void *end);
...
size_t utf8substrlen(const void *str, const void* end) {
    const unsigned char *s = (const unsigned char *)str;
    size_t length = 0;
