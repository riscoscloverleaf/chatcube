...
typedef enum { ROSPRITE_RGB, ROSPRITE_CMYK, ROSPRITE_RGB565 } rosprite_color_model;
...
typedef struct {
    ...
    int xeig;
    int yeig;
    int true_colour_flag;
} roscreen;

roscreen rosprite_get_screen_info();

int rosprite_capture_screenshoot(struct rosprite **sprite, int x1 = 0, int y1 = 0, int x2 = 0, int y2 = 0);
