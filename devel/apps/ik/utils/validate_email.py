...
try:
    ...
    DNS.defaults['server'] = ['127.0.0.1', '8.8.8.8']
...
def verify_email_address(email, check_mx=True, verify=True, debug=False, smtp_timeout=10):
    ...
    if debug:
        logger = logging.getLogger('ik.validate_email')
